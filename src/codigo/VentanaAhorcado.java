    ...
    private void chequeaLetra (String letra){
        ...
        for (int i=0; i<palabraOculta.length();i++){
            if (palabraOculta.charAt(i) == letra.charAt(0)){
                // quitar el guion y poner la letra correspondiente
        ...
        jLabel1.setText(palabraConGuiones); // actualizo el valor que se muestra en la pantalla con las letras adivinadas
